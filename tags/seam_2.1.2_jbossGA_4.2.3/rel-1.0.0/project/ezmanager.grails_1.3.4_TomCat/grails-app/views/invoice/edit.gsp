                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: invoiceInstance, field: 'invoiceId', 'errors')}">
                                    <g:textField name="invoiceId" value="${fieldValue(bean: invoiceInstance, field: 'invoiceId')}" />
                                </td>
                            </tr>
