                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="countryId"><g:message code="country.countryId.label" default="Country Id" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: countryInstance, field: 'countryId', 'errors')}">
                                    <g:textField name="countryId" value="${fieldValue(bean: countryInstance, field: 'countryId')}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: countryInstance, field: 'name', 'errors')}">
                                    <g:textField name="name" maxlength="100" value="${countryInstance?.name}" />
                                </td>
                            </tr>
