    ...
    <body>
        ...
        <div class="body">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="userIdentityId" title="${message(code: 'userIdentity.userIdentityId.label', default: 'User Identity Id')}" />
                        
                            <g:sortableColumn property="name" title="${message(code: 'userIdentity.name.label', default: 'Name')}" />
                        
                            <g:sortableColumn property="isActive" title="${message(code: 'userIdentity.isActive.label', default: 'Is Active')}" />
            ...
            <div class="paginateButtons">
                <g:paginate total="${userIdentityInstanceTotal}" />
            </div>
        </div>
    </body>
</html>
