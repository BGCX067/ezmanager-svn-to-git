...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="state.countryIdCountry.label" default="Country" /></td>
                            
                            <td valign="top" class="value"><g:link controller="country" action="show" id="${stateInstance?.countryIdCountry?.countryId}">${stateInstance?.countryIdCountry?.name}</g:link></td>
            ...
            <div class="buttons">
                <g:form>
                    <g:hiddenField name="id" value="${stateInstance?.stateId}" />
