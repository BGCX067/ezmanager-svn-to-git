...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                <g:hiddenField name="id" value="${streetInstance?.id}" />
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: streetInstance, field: 'streetId', 'errors')}">
                                    <g:textField name="streetId" value="${fieldValue(bean: streetInstance, field: 'streetId')}" />
                                </td>
                            </tr>
