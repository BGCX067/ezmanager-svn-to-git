                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: addressInstance, field: 'addressId', 'errors')}">
                                    <g:textField name="addressId" value="${fieldValue(bean: addressInstance, field: 'addressId')}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="streetIdStreet"><g:message code="address.streetIdStreet.label" default="Street" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: addressInstance, field: 'streetIdStreet', 'errors')}">
                                    <g:select name="streetIdStreet.streetId" from="${Street.list()}" optionKey="streetId" optionValaue="name" value="${addressInstance?.streetIdStreet?.streetId}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: addressInstance, field: 'customerList', 'errors')}">
                                    <g:select name="customerList" from="${Customer.list()}" multiple="yes" optionKey="id" size="5" value="${addressInstance?.customerList*.customerId}" />
                                </td>
                            </tr>
