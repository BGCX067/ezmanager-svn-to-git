            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="cost.taskIdTask.label" default="Task" /></td>
                            
                            <td valign="top" class="value"><g:link controller="task" action="show" id="${costInstance?.taskIdTask?.taskId}">${costInstance?.taskIdTask?.name}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="cost.vatIdBaseVat.label" default="Vat" /></td>
                            
                            <td valign="top" class="value"><g:link controller="baseVat" action="show" id="${costInstance?.vatIdBaseVat?.vatId}">${costInstance?.vatIdBaseVat?.name}</g:link></td>
