            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="project.statusIdBaseStatus.label" default="Status" /></td>
                            
                            <td valign="top" class="value"><g:link controller="baseStatus" action="show" id="${projectInstance?.statusIdBaseStatus?.statusId}">${projectInstance?.statusIdBaseStatus?.name}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="project.customerList.label" default="Customer List" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${projectInstance.customerList}" var="c">
