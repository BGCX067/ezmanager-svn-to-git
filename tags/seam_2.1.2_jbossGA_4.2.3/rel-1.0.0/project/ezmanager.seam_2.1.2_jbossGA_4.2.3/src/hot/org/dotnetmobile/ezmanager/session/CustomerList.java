...
public class CustomerList extends EntityQuery<Customer> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4187487830873653983L;

	private static final String EJBQL = "select customer from Customer customer";

	private static final String[] RESTRICTIONS = { "lower(customer.name) like lower(concat(#{customerList.customer.name},'%'))", };
