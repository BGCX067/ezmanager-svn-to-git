...
public class CountryList extends EntityQuery<Country> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6627458339361035345L;

	private static final String EJBQL = "select country from Country country";

	private static final String[] RESTRICTIONS = { "lower(country.name) like lower(concat(#{countryList.country.name},'%'))", };
