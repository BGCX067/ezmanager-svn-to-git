...
public class ProjectCustomerList extends EntityQuery<ProjectCustomer> {

	private static final String EJBQL = "select projectCustomer from ProjectCustomer projectCustomer";
	...
	public ProjectCustomer getProjectCustomer() {
