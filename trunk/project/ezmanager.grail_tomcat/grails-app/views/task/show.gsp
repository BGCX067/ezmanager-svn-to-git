                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="project" action="show" id="${taskInstance?.project?.projectId}">${taskInstance?.project?.name}</g:link></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="baseStatus" action="show" id="${taskInstance?.status?.statusId}">${taskInstance?.status?.name}</g:link></td>
