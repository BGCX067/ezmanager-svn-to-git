                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: roleIdentityInstance, field: 'userIdentityList', 'errors')}">
                                    <g:select name="userIdentityList" from="${UserIdentity.listOrderByName()}" multiple="yes" optionKey="userIdentityId" optionValue="name" size="5" value="${roleIdentityInstance?.userIdentityList*.userIdentityId}" />
                                </td>
                            </tr>
