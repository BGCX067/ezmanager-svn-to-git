                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="street" action="show" id="${addressInstance?.street?.streetId}">${addressInstance?.street?.name}</g:link></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="address.street.city.label" default="City" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: addressInstance, field: "street.city.name")}</td>
