            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="executedTask.executedByUser.label" default="Executed By User" /></td>
                            
                            <td valign="top" class="value"><g:link controller="userIdentity" action="show" id="${executedTaskInstance?.executedByUser?.userIdentityId}">${executedTaskInstance?.executedByUser?.name}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="executedTask.task.label" default="Task" /></td>
                            
                            <td valign="top" class="value"><g:link controller="task" action="show" id="${executedTaskInstance?.task?.taskId}">${executedTaskInstance?.task?.name}</g:link></td>
