            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="baseVat.currency.label" default="Currency" /></td>
                            
                            <td valign="top" class="value"><g:link controller="baseCurrency" action="show" id="${baseVatInstance?.currency?.currencyId}">${baseVatInstance?.currency?.name}</g:link></td>
