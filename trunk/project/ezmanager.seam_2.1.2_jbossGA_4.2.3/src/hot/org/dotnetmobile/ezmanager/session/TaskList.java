...
public class TaskList extends EntityQuery<Task> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6368187347585288279L;

	private static final String EJBQL = "select task from Task task";

	private static final String[] RESTRICTIONS = { "lower(task.name) like lower(concat(#{taskList.task.name},'%'))", };
