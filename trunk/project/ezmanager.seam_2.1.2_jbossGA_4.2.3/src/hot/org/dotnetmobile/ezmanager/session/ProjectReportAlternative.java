...
@Name("projectReportAlternative")
public class ProjectReportAlternative extends EntityController {
	@Logger private Log log;
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -13445282515424802L;
